...
//include "../views/listeCommandeAdmin.php";
...
?>
                  ...
                  <tr>
                  <td>Prenom</td>
                  <td><input class="form-control" type="text" name="prenom" placeholder="prenom" value="<?PHP echo $prenom ?>"></td>
                  </tr>
                  <tr>
                  <td>Nom</td>
                  <td><input class="form-control"  type="text" name="nom" placeholder="nom"value="<?PHP echo $nom ?>"></td>
                  </tr>
                  <tr>
                  <td>numero</td>
                  <td><input class="form-control"  type="number" name="numero" placeholder="numero" value="<?PHP echo $numero ?>"></td>
                  </tr>
                  <tr>
                  <td>adresse</td>
                  ...
                  <tr>
                    ...
                    <td>id_produit</td>
                    <td><input class="form-control" type="number" name="id_produit" placeholder="id_produit" value="<?PHP echo $id_produit ?>"></td>
                    </tr>


                  <td>quantite</td>
                  <td><input  class="form-control" type="number" name="quantite" placeholder="quantite" value="<?PHP echo $quantite ?>"></td>
                  </tr>
                  <tr>
                  <td>prixUnitaire</td>
                  <td><input  class="form-control" type="number" name="prixUnitaire"  placeholder="prixUnitaire" value="<?PHP echo $prixUnitaire ?>"></td>
                  </tr>
                  <tr>
                  <td>details</td>
                  <td><input  class="form-control" type="text" name="details" placeholder="details" value="<?PHP echo $details ?>"></td>
                  </tr>
                  <tr>
                  <td></td>
                  <br>
                  <br>
                  <td><input type="submit" name="modifier" class="btn btn-primary waves-effect waves-light m-r-10" value="modifier"></td>
                  </tr>
                  <tr>
                  <td></td>
