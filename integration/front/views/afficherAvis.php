...
?>
    <div class="page-header parallax" style="background-image:url(file:///C:/Users/lenovo/Desktop/TheAutocars/car2.jpg);">
    	<div class="container">
        	<h1 class="page-title">Afficher Avis</h1>
       	</div>
    </div>
    <!-- Utiity Bar -->
        	...
        	<div class="row">
            	<div class="col-md-8 col-sm-6 col-xs-8">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">afficher avis</li>
                    </ol>
            	</div>
...
<table class="table table-bordered table-responsive dashbord-tables saved-cars-table">
<tr>
<td>Avis</td>
<td>Note</td>
<td>supprimer</td>
			...
			<div class="container">
						<div class="row">
							...
							<div class="col-md-5 col-sm-6 footer_widget widget text_widget">
									<h4 class="widgettitle">About Platinium Auto</h4>
			...
			<div class="container">
						<div class="row">
							<div class="col-md-6 col-sm-6 copyrights-left">
									<p>&copy; 2018 Platinium Auto. All Rights Reserved</p>
								</div>
