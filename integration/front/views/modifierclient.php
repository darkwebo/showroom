...
<div class="body">
  ...
  s</a></li>
                            ...
                            <li><a href="#">ESspace Clients</a></li>
                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item active"> <a href="user-dashboard-profile.html"><i class="fa fa-user"></i> Espace Client</a></li>
                        ...
                        <div class="col-md-9 col-sm-8">
                            ...
                            <div class="dashboard-block">
                                <div class="tabs profile-tabs">
                                    ...
                                    </ul><form method="POST" action="modifierclient.php">
<table>
...
<tr>
<td>identifiant</td>
<td><input type="number" class="form-control" name="idC" value="<?PHP echo $idC ?>"></td>
</tr>
<tr>
<td>Nom</td>
<td><input type="text" class="form-control" name="nomC" value="<?PHP echo $nomC ?>"></td>
</tr>
<tr>
<td>Prenom</td>
<td><input type="text" class="form-control" name="prenomC" value="<?PHP echo $prenomC ?>"></td>
</tr>
<tr>
<td>telephone</td>
<td><input type="number" class="form-control" name="telephone" value="<?PHP echo $telephone ?>"></td>
</tr>
<tr>
<td>mail</td>
<td><input type="text" class="form-control" name="mail" value="<?PHP echo $mail ?>"></td>
</tr>
...
<tr>
	<td>adressC</td>
<td><input type="text" class="form-control" name="adressC" value="<?PHP echo $adressC ?>"></td>
</tr>
<tr>
<td></td>
<input type="submit" name="modifier" class="btn btn-primary btn-block" value="modifier">
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$client=new client($_POST['idC'],$_POST['nomC'],$_POST['prenomC'],$_POST['telephone'],$_POST['mail'],$_POST['password'],$_POST['adressC']);
