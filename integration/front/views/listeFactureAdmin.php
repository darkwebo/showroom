    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="indexx.html"><img  class="main-logo" src="img/logo/logo.jpg" alt="" height="220" width="200"></a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="logo1.jpg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="product-edit.html">Facture</a></li>
                        ...
                        <div class="product-status-wrap">
                          ...
                          <table>
                                ...
                                foreach($listeFactures as $row){
                                	...
                                	<td><a href="modifierFactureAdmin.php?id_produit=<?php echo $row['id_produit']; ?>">
                                	Modifier</a></td>
                                	</tr>
                                	<?php
                                }
