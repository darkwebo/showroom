...
$option1=new cars();
$option1=$option1->affichercar2($_GET['name']);
        	...
        	<div class="container">
                ...
                <article class="single-vehicle-details">
                    <div class="single-vehicle-title">
                        <span class="badge-premium-listing">listing</span>
                    ...
                    <div class="single-listing-actions">
                      <!--  <div class="btn-group pull-right" role="group">
                        ...
                        <div class="btn btn-info price"><?PHP echo $row['PRICE'];  ?>DT</div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="single-listing-images">
                                <div class="featured-image format-image">
                                    <a href="<?PHP echo $row['PHOTO'];  ?>" data-rel="prettyPhoto[gallery]" class="media-box"><img src="<?PHP echo $row['PHOTO'];  ?>" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="sidebar-widget widget">
                                <ul class="list-group">
                                    <li class="list-group-item"> <span class="badge">Year</span> <?PHP echo $row['YEAR'];  ?></li>
                                    <li class="list-group-item"> <span class="badge">Make</span> <?PHP echo $row['MAKE'];  ?></li>
                                    <li class="list-group-item"> <span class="badge">Model</span> <?PHP echo $row['MODEL'];  ?></li>
                                    <li class="list-group-item"> <span class="badge">Body style</span> <?PHP echo $row['BODY_TYPE'];  ?></li>
                                    <li class="list-group-item"> <span class="badge">Mileage</span> <?PHP echo $row['MILEAGE'];  ?>KM</li>
                                    <li class="list-group-item"> <span class="badge">Transmission</span> <?PHP echo $row['TRANSMISSION'];  ?></li>
                                    <li class="list-group-item"> <span class="badge">Horse Power</span> <?PHP echo $row['CV'];  ?>CV</li>

                                    <li class="list-group-item"> <span class="badge">Fuel type</span> <?PHP echo $row['FUEL_TYPE'];  ?></li>
                                </ul>
                            </div>
                        </div>
                   	</div>
                    	...
                    	<div class="col-md-6">
                            <div class="input-group">
                                ...
                                <select type="text" class="form-control selectpicker">
                                	<option selected>Financing Type</option>
