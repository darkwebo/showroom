	...
	<div class="site-header-wrapper">
        <header class="site-header">
            <div class="container sp-cont">
                <div class="site-logo">
                    <h1><a href="index.html"><img src="logo1.jpg" alt="Logo"></a></h1>
				...
				<div class="navbar">
						<div class="container sp-cont">
								<div class="search-function">
										<a href="" class="search-trigger"><i class="fa fa-search"></i> <img src="car.jpg" alt="Logo" style="size=cover"></a>
											...
											<li><a href="index.html">Acceuil</a>
											 <li><a href="contact.html">Contacts</a>
													 <li><a href="about.html">A propos</a>
															<li><a href="joinus.html">Mon espace</a>
																	<li><a href="gallery-2cols-details.html">Gallerie </a></li>

										<!--    <li class="megamenu"><a href="index.html">Marketing</a>
														<ul class="dropdown">
																<li>
																				...
																				<div class="row">
																						<div class="mm-col col-md-2">
																								<ul class="sub-menu">
																										...
																										<li><a href="blog.html">Auto news and event</a></li>
																								</ul>
																						</div>
																						...
																						<div class="mm-col col-md-5">
																								...
																								<ul class="make-widget">
																										<li class="item"> <a href=""><img src="car.jpg" alt=""></a></li>
																						<li class="item"> <a href="results-list.html"><img src="car2.jpg" alt=""></a></li>
																						<li class="item"> <a href="results-list.html"><img src="car.jpg" alt=""></a></li>
																										<li class="item"> <a href="results-list.html"><img src="car4.jpg" alt=""></a></li>
																										<li class="item"> <a href="results-list.html"><img src="car3.jpg" alt=""></a></li>
												...
												<li><a href="javascript:void(0)">Annonces</a>
														<ul class="dropdown">
																<li><a href="results-list.html">Liste des annonces</a></li>
																<li><a href="vehicle-details.html">details plus</a></li>
																<li><a href="add-listing-form.html">Ajouter annonce</a></li>
																<li><a href="vehicle-comparision.html"> Comparaison</a></li>
															 <li><a href="user-dashboard-manage-ads.php">gerer annonces</a></li>
														</ul>
												</li>
												...
												<li><a href="javascript:void(0)">Evaluation</a>
														<ul class="dropdown">
																<li><a href="blog.html">Reclamation</a></li>
																<li><a href="blog-masonry.html">Avis</a></li>
														</ul>
												</li>
										</ul>
								</nav>
                ...
                <div class="col3 comparision-table">
                	<div class="tsticky thead-sticky comp-table-row">
                        ...
                        <div class="comp-table-col">
							...
							<input type="text" name="name1" class="form-control" placeholder="voiture pour comparer" >
                        ...
                        <div class="comp-table-col">
							...
							<input type="text" name="name2" class="form-control" placeholder="voiture pour comparer" >

                        </div>
                        <div class="comp-table-col">


									<input type="text" name="name3" class="form-control" placeholder="voiture pour comparer" >


							  </div>
							  <input type="submit" value="Comparer" class="form-control"  >
                    </div></form>
					<?PHP
include "../core/cars.php";
if (isset($_POST['name1'])){
$option1=new cars();
$option1=$option1->affichercar2($_POST['name1']);
foreach($option1 as $row1){

$option2=new cars();
$option2=$option2->affichercar2($_POST['name2']);
foreach($option2 as $row2){

$option3=new cars();
$option3=$option3->affichercar2($_POST['name3']);
foreach($option3 as $row3){

	?>
                	<div class="comp-image comp-table-row">
                        <div class="comp-table-col">&nbsp;</div>
                        <div class="comp-table-col"><div class="img-thumbnail"><img src="<?PHP echo $row1['PHOTO'];  ?>" alt=""></div></div>
                        <div class="comp-table-col"><div class="img-thumbnail"><img src="<?PHP echo $row2['PHOTO'];  ?>" alt=""></div></div>
                        <div class="comp-table-col"><div class="img-thumbnail"><img src="<?PHP echo $row3['PHOTO'];  ?>" alt=""></div></div>
                    </div>
                	...
                	<div class="comp-table-row">
                        ...
                        <div class="comp-table-col"><?PHP echo $row1['MILEAGE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row2['MILEAGE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row3['MILEAGE'];  ?></div>
                    </div>
                	<div class="comp-table-row">
                        <div class="comp-table-col">Body</div>
                        <div class="comp-table-col"><?PHP echo $row1['BODY_TYPE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row2['BODY_TYPE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row3['BODY_TYPE'];  ?></div>
                    </div>
                	<div class="comp-table-row">
                        <div class="comp-table-col">Transmission</div>
                        <div class="comp-table-col"><?PHP echo $row1['TRANSMISSION'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row2['TRANSMISSION'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row3['TRANSMISSION'];  ?></div>
                    </div>

                	<div class="comp-table-row">
                        <div class="comp-table-col">DriveType</div>
                        <div class="comp-table-col"><?PHP echo $row1['PRICE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row2['PRICE'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row3['PRICE'];  ?></div>
                    </div>

                	<div class="comp-table-row">
                        <div class="comp-table-col">Year</div>
                        <div class="comp-table-col"><?PHP echo $row1['CV'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row2['CV'];  ?></div>
                        <div class="comp-table-col"><?PHP echo $row3['CV'];  ?></div>
                    </div>
