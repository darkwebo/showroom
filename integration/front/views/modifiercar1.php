            ...
            <div class="container sp-cont">
                ...
                <nav class="main-navigation dd-menu toggle-menu" role="navigation">
                    <ul class="sf-menu">
                        ...
                        <li class="megamenu"><a href="results-list.php">Search</a>

                        </li>
                        <li><a href="javascript:void(0)">Listing</a>
                            <ul class="dropdown">
                                <li><a href="results-list.php">View All Cars</a></li>
                      ...
                      <div id="listing-add-form-one" class="tab-pane fade in active">
                                    ...
                                    <div class="tabs listing-step-tabs">
                                        <ul class="nav nav-tabs">
                                            <li class="active"> <a data-toggle="tab" href="#searchvehicle" aria-controls="searchvehicle" role="tab">Modify Vehicle</a></li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="searchvehicle" class="tab-pane fade in active">
                                                <form method="POST" action="modifiercar.php" enctype="multipart/form-data" >
												  ...
												  <input type="hidden" name="id" size="35" value="<?PHP echo $_GET['name'];?>"  >



																	<label>Select Manufacture Year*</label>
																	<div class="input-group">
															<input type="number" name="year"  class="form-control" placeholder="" min="1990" max""2030" required>
															<span class="input-group-addon">YEAR</span>
														</div>
														<label>Enter Mileage*</label>
														<div class="input-group">
															<input type="number" name="mileage" class="form-control" placeholder="" min="0" max""100000000" required>
															<span class="input-group-addon">KM</span>
														</div>
														<label>Enter Puissance Fiscal</label>
																	<div class="input-group">
															<input type="number"name="cv" class="form-control" placeholder="" min="2" max""100" required>
															<span class="input-group-addon">CV</span>
														</div>
														<label>Enter Price</label>
																	<div class="input-group">
															<input type="number" name="price" class="form-control" placeholder="" min="5000" max""10000000" required>
															<span class="input-group-addon">DT</span>
														</div>
														<label>New name</label>
												  <div class="input-group">
														<input type="text" name="name" size="35"  pattern="[a-zA-Z0-9]{2,20}" class="form-control" placeholder="" required>
													</div>
														<div>
													...
													<div class="col-md-6">
													<label id="lblv" >Select Make</label>
												  ...
												  <div class="input-group">
														<input type="text" name="model" size="35" pattern="[a-zA-Z0-9]{2,}" class="form-control" placeholder="" required >
													</div>
												...
												<label>Select Fuel Type</label>
													...
													<label>Select Transmission Type</label>
                                                        ...
                                                        <select name="body_type" class="form-control selectpicker" required>
                                                            <option value="other">Select</option>
...
foreach($option2 as $row){
	?>
<li  class="checkbox"><label><input type="checkbox" name="opt[]" value="<li><?PHP echo $row['opt']; ?></li>"><?PHP echo $row['opt']; ?></label></li>
	<?PHP
}
?>
                                	...
                                	<input type="submit" name="ajouter" value="Modifier" class="btn btn-info pull-right" />
