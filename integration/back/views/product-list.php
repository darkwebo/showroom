                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                <tr>
									...
									<?PHP	include "../core/cars.php";
$option2= new cars();
$option2=$option2->affichercar();
foreach($option2 as $row){?>
                                <tr>
                                    <td><a href="product-detail.php?name=<?PHP echo $row['NAME']; ?>"> <?PHP echo $row['NAME'];?></a></td>
                                    <td><?PHP echo $row['CV'];?>CV</td>
                                    <td>
                                        <button class="pd-setting"><?PHP echo $row['PRICE'];?> DT</button>
                                    </td>
                                    ...
                                    <td>
                                    	<a href="modifiercar1.php?name=<?PHP echo $row['ID']; ?>"> <input type="submit" value="Modifier"  class="text-default" title="modifier"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></input>  </a>

                                       <form method="POST" action="supprimercar.php">
									   <input type="hidden" name="id" value="<?PHP echo $row['ID'];?>">
									   <input type="submit" value="supprimer" data-toggle="tooltip" title="Trash" class="pd-setting-ed"   ><i class="fa fa-trash-o" aria-hidden="true"></i></input></form>
                                    </td>
                                </tr>
<?PHP } ?>
                            </table>
...
foreach($option2 as $row){
	?>
	  <tr>
                                    ...
                                    <th><form method="POST" action="supprimeroption.php">
			   <input type="hidden" name="opt" value="<?PHP echo $row['opt'];?>">
			   <input type="submit" value="supprimer" data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></input></form>
                     </th>
									</tr>
