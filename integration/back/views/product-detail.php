                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                        <div class="single-product-details res-pro-tb">
                            ...
                            <div class="single-pro-price">
                                <span class="single-regular"> <?PHP echo $row['PRICE'];  ?>DT</span><span class="single-old"></span>
                            </div>
                            <div class="single-pro-size">
								...
								<ul class="add-features-list">
								 <ul class="list-group">
                                    ...
                                    <li> Body style: <?PHP echo $row['BODY_TYPE'];  ?></li>
                                    <li>Mileage :<?PHP echo $row['MILEAGE'];  ?>KM</li>
                                    <li>Transmission: <?PHP echo $row['TRANSMISSION'];  ?></li>
                                    <li>Horse Power :<?PHP echo $row['CV'];  ?>CV</li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <ul id="myTab" class="tab-review-design">
                            ...
                            <span><i class="fa fa-star"></i><i class="fa fa-star"></i></span></a></li>
                            <li><a href="#INFORMATION">Options</a></li>
                        </ul>
