    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="indexx.html"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                          ...
                                          <tr>
                                          <td></td>
                                          <td><input type="submit" class="btn btn-primary waves-effect waves-light m-r-10" name="modifier" value="modifier"></td>
                                          </tr>
                                          <tr>
                                          <td></td>
