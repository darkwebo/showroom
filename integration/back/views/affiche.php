...
foreach($listelivraisons as $row){
	?>
                               ...
                               <?PHP echo $row['dat']; ?>
                                                    ...
                                                    <td>
                                                        <center>
    <a href=" modifierlivraison1.php?idL=<?PHP echo $row['idL']; ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>
                                                <?PHP
        }
