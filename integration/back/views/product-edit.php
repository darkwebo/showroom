                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
										     <form method="POST" action="ajoutcar.php" >
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="mileage" name="mileage" min="0" max="100000000" required >
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="number" name="year"  class="form-control" placeholder="year" min="1990" max""2030" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></span>
                                                       <input type="number"name="cv" class="form-control" placeholder="cv" min="2" max="100" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                       <input type="number" name="price" class="form-control" placeholder="price" min="5000" max""10000000" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                       <input type="text"  name="model" size="35" pattern="[a-zA-Z][0-9]{2,}" class="form-control" placeholder="model" required>
                                                    </div>


                                                        <select name="transmission" class="form-control selectpicker" required>
                                                            <option value="other">Select transmission type </option>
                                                 ...
                                                 &nbsp;
                                                        ...
                                                        <select  name="fuel_type" class="form-control selectpicker" required>
                                                            <option value="other" >Select fuel type</option>
                                               ...
                                               <select name="make" class="form-control pro-edt-select form-control-primary" required>

													  <option value="other">Select Make</option>
                                                    ...
                                                    &nbsp;
                                                    <select name="body_type" class="form-control pro-edt-select form-control-primary" required>
                                    ...
                                    <div class="panel panel-default">
  										<div class="panel-body">
                                        	<ul  name="opt" class="optional-features-list">
<?PHP
include "../core/options.php";
$option2=new options();
$option2=$option2->afficheroption();

foreach($option2 as $row){
	?>
		<li class="checkbox"><label><input type="checkbox" name="opt[]" value="<?PHP echo $row['opt']; ?>"> <?PHP echo $row['opt']; ?></label></li>
	<?PHP
}
?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input type="submit" name="ajouter" value="ajouter" class="btn btn-primary waves-effect waves-light m-r-10"/>
														</form>

                                                </div>
												<form method="POST" action="ajoutoption.php" >
												<h3>Add features in the list</h3>
												<div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" name="description"  class="form-control" placeholder="option" >

                                                    </div><input type="submit" name="ajouter" value="ajouter options" class="btn btn-primary waves-effect waves-light m-r-10"/></form>
                                        </div>
                                    </div>
