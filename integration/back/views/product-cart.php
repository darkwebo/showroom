        ...
        foreach($listelivreurs as $row){
			?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                  <p class="text-muted"><?PHP echo $row['nomP']; ?></p>
                                                    </td>
                                                    <td>
                                                        <p>
							   <?PHP echo $row['prenomP']; ?>
                                </p>
                                                    </td>
                                                    <td><p>
                                <?PHP echo $row['tarif']; ?>
								...
								<?PHP echo $row['nbh']; ?>
                                                    ...
                                                    <td>
                                                        <center>
    <a href=" modifierlivreur1.php?idP=<?PHP echo $row['idP']; ?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>
                                                <?PHP
		}
