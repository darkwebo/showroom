...
{
 $output .= '<option value="'.$row["id_ligne"].'">'.$row["id_ligne"].'</option>';
		  ...
		  <div class="contact-grid-agile-w3s">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>modifier livraison</h4>
							<form action="livraisonmodifier.html">
	   ...
	   <div class="agile-contact-grids">
				<div class="agile-contact-left">
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls"><span>modifier</span> de livraison</h4>
						<form action="livraisonmodifier.php" method="POST">

							
                           
							<div class="styled-input agile-styled-input-top">
								<input type="number" name="numLivraison" value="<?php echo $row['numLivraison'] ?>" required="">
								<label>Numero de livraison</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="nomClient" value="<?php echo $row['nomClient'] ?>" required="" onblur="verifNom(this)"> 
								<label>Nom du client</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="text" name="adresseClient" value="<?php echo $row['adresseClient'] ?>" required="" onblur="verifNom(this)">
								<label>Adresse du client</label>
								<span></span>
							</div>
								
								<div class="styled-input">
								<input type="text" name="ville" value="<?php echo $row['ville'] ?>" required="" onblur="verifNom(this)">
								<label>Ville</label>
								<span></span>
							</div>	 
								<div class="styled-input">
								<label>numero de la commande</label>
    								 <select name="numCommande" id="numCommande" class="form-control">
     								 <option value=""></option>
      									<?php echo $output; ?>
     									</select>
							</div>
							<input type="submit" value="MODIFIER" name="modifbutton">
						</form>
						<?php
        }
        } 
        if (isset($_POST['modifbutton']))
        {
            $liv= new livraison($_POST['numLivraison'],$_POST['nomClient'],$_POST['adresseClient'],$_POST['ville'],$_POST['numCommande']);
            $livraisonC = new livraisonC();
            $livraisonC->update_liv($liv);
