...
<script type="text/javascript" src="//localhost/frontoffice/views/livechat/php/app.php?widget-init.js"></script>
</head>
<body>
<!-- header -->
								...
								<div class="men-pro-item simpleCart_shelfItem">
										...
										<img src=<?=$chemin3?> alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php?id=<?php echo $data['id'];?>" class="link-product-add-cart">Aperçu Rapide</a>
												</div>
											</div>
                                   ...
                                   <?php
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
													...
													<form action="ajoutersav.php" method="GET">
															<fieldset>
															<input type="hidden" name="recid" value="<?=$data["id"]?>">
	
														<input type="submit" name="reclamation" value="reclamation" class="button" />
			...
			<div class="sign-grds">
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Addresse mail</h6>
								<p>mail :<a href="mailto:example@email.com"> SDA@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						...
						<li><a href="single.html"><img src="images/t5.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="images/t6.jpg" alt=" " class="img-responsive" /></a></li>
					</ul>
				</div>
				<div class="clearfix"></div>
			</div>
