   ...
   $donne=$_GET['num'];
        ...
        ?>
                ...
                ?>
						...
						<form action="modifsavv.php" method="POST">

							<div class="styled-input agile-styled-input-top">
							<input type="image" value="submit" src="images/search1.png" alt="submit Button" onMouseOver="this.src='images/search1.png'" align="right" name="cherbutton"><input type="text" name="cher" placeholder="Rechercher..." value="<?php echo $row['num']; ?>" required="">
							</div>
							...
							<div class="styled-input">
								<input type="text" name="idclient" value="<?php echo $row['id']; ?>" required=""> 
							...
							<div class="styled-input">
								<input type="text" name="Subject" value="<?php echo $row['sujet']; ?>" required="">
								<label>Sujet</label>
								<span></span>
							</div>
							<div class="styled-input">
