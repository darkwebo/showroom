...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Detail Sur Le <span>Produit </span></h3>
			<!--/w3_short-->
...
<?php
$products=$db->prepare("SELECT * FROM produit where id = '$id'");
$products->execute();
$result=$products->fetchAll(PDO::FETCH_OBJ);
foreach ($result as $product): ?>
					<ul class="slides">
						<li data-thumb="images/<?php echo $product->id;?>.jpg">
							<div class="thumb-image"> <img src="images/<?php echo $product->id;?>.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price"><?php echo $product->prix;?> DT</span> <del>- <?php echo ($product->prix-250);?> DT</del></p>
					<div class="rating1">
					...
					<div class="color-quality">
						<div class="color-quality-right">
							<h5>Quality :</h5>
							<select type="hidden" id="country1" name="count" class="frm-field required sect">
								<?php for($i=0;$i< $product->quantite; $i++){?>
								     <option value="null"><?php echo $product->quantite-$i ?></option> 
                                <?php }?>
							</select>
						</div>
					</div>
					<div class="occasion-cart">
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="../core/addpanier.php" method="GET">
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
					<fieldset>
					    <input type="hidden" name="id" value="<?php echo $product->id ?>">
					    <input type="submit" name="submit" class="button" value="Ajouter au Panier">
					</fieldset>
					</div>
				</form>
														</div>
