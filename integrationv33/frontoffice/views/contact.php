			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="contact.php">Contacts</a></li>
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>Ariana <span>Tunis, Tunisie.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Mail</h4>
							<p><a href="mailto:info@example.com">info@exemple1.com</a><span><a href="mailto:info@example.com">info@exemple2.com</a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
	   ...
	   <div class="agile-contact-grids">
				<div class="agile-contact-left">
					<div class="col-md-6 address-grid">
						<h4>Pour Plus d'<span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-volume-control-phone" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Telephone </p><span>+216 54 668 585</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@example.com">info@exemple.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Localisation</p><span>Ariana, Tunis, Tunisie.</span>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls"><span>Formulaire</span> de contact</h4>
						<form action="#" method="post">
							<div class="styled-input agile-styled-input-top">
