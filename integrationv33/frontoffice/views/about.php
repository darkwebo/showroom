			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="about.php">A Propos</a></li>
			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
				    <h5>A propos de <span> S.D.A</span> </h5>
...
<div class="banner_bottom_agile_info team">
	<div class="container">
	            <h3 class="wthree_text_info">Notre <span>Equipe</span></h3>
			<div class="inner_w3l_agile_grids">
					<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							...
							<div class="caption">
								<h4>Rochinel Nanfa</h4>
								<p>Ajouter une courte description</p>						
							</div>
