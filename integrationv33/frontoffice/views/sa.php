			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item"><a class="menu__link" href="index.php">Acceuil <span class="sr-only">(current)</span></a></li>
				...
				<div class="agile-contact-left">
					...
					<div class="col-md-6 contact-form">
						...
						<form action="sav.php" method="POST">
							...
							<div class="styled-input">
								<input type="text" name="id_vente" required="id de vente"> 
								<label>id devente</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="email" name="Email" required=""> 
