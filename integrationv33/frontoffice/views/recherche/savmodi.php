			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="contact.html">Contacts</a></li>
					<li class=" menu__item"><a class="menu__link" href="contact.html">F.A.Q</a></li>
					<li class=" menu__item"><a class="menu__link" href="sav.html">S.A.V</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
...
<div class="page-head_agile_info_w3l">
				...
				<div class="clearfix"></div>
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>modifier reclamation</h4>
							<form action="savmodi.html">
							<input type="image" value="submit" src="images/arrow1.png" alt="submit Button" onMouseOver="this.src='images/arrow1.png'">
							<div class="clearfix"></div>
			                 </form>
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>supprimer reclamatiant</h4>
							<form action="savsupp.html" method="post">
					       <input type="image" value="submit" src="images/arrow1.png" alt="submit Button" onMouseOver="this.src='images/arrow1.png'">
				<div class="clearfix"></div>
			</form>
  ...
  $config=config::getConnexion();
   $donne=$_POST['num'];
            ...
            $sql =$config->prepare("SELECT * FROM sav where num=$donne") ;
            $sql->execute();
        ...
        ?>
                ...
                ?>
						...
						<form action="savmodi.php" method="GET">
							...
							<div class="styled-input">
								<input type="text" name="idclient" value=" $row['id']" required=""> 
							...
							<div class="styled-input">
								<input type="text" name="Subject" value="$row['sujet']" required="">
								<label>Sujet</label>
								<span></span>
							</div>
							<div class="styled-input">
								<textarea name="Message" value="$row['Message']" required=""></textarea>
								<label>Message</label>
								<span></span>
							</div>	 
