		  ...
		  <div class="contact-grid-agile-w3s">
		  	<div class="col-md-3 w3layouts_mail_grid_left" >
					...
					<div class="w3layouts_mail_grid_left2">
						<h3 align="center" style="position: absolute; left: 70px; top: 10px; width: 80%; height: 80%; z-index: 100;">LIVRAISON GRATUITE </h3>
					</div>
...
<table id="example1" class="table table-striped table-bordered" >
        ...
        <tbody>
        	...
        	foreach ($list as $row) 
				{?>
            <tr>
                <td><?php echo $row['numLivraison']; ?></td>
                <td><?php echo $row['nomClient']; ?></td>
                <td><?php echo $row['adresseClient']; ?></td>
                <td><?php echo $row['ville']; ?></td>
                <td><?php echo $row['numCommande'];?></td>
                <td>
                	<a class="btn btn-danger" href="supprimerlivraison.php?id=<?PHP echo $row['numLivraison']; ?>">Delete</a>
                </td>
				<td>
					<form action="livraisonmodifier.php" method="post">
    					<input type="submit" class="btn btn-default" name="modify" value="modify" class="internal__input" />
         				<input type="hidden" value="<?php echo $row['numLivraison']; ?>" name="id">
					</form>
				</td>
            </tr>
            <?php 
