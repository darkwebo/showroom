	   ...
	   <div class="agile-contact-grids">
				<div class="agile-contact-left">
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls"><span>envoyer</span> une livraison</h4>
						<form action="ajouterlivraison.php" method="POST">
                            
							<div class="styled-input agile-styled-input-top">
								<input type="number" name="numLivraison" required="">
								<label>Numero de livraison</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="nomClient" required="" onblur="verifNom(this)"> 
								<label>Nom du client</label>
								<span></span>
							</div> 
							
							<div class="styled-input">
								<input type="text" name="adresseClient" required="" onblur="verifNom(this)">
								<label>Adresse du client</label>
								<span></span>
							</div>
								<div class="styled-input">
								<input type="text" name="ville" required="" onblur="verifNom(this)">
								<label>Ville</label>
								<span></span>
							</div>	
							<div class="styled-input">
