...
$lastProducts =$produitC->afficherProduit();
?>
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item menu__item--current">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Nos Produit <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="images/agr1.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html">Pesticide</a></li>
											<li><a href="mens.html">Grain</a></li>
											<li><a href="mens.html">Materiel</a></li>
					...
					<li class=" menu__item"><a class="menu__link" href="contact.html">S.A.V</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				<h4>Categories</h4>
							...
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Nos produit</label>
								<ul>
									<li><a href="mens.html">GRAINS</a></li>
									<li><a href="mens.html">Pesticide</a></li>
									<li><a href="mens.html">Materiel</a></li>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="images/agr2.jpg" alt=" " />
				</div>
				<div class="col-sm-8 men-wear-right">
					<h4>Nos produit </h4>
					<p>Une gamme complète d'engrais, 
pour des plantes en bonne santé.
Nous scrutons le marché, et guettons en permanence les meilleurs prix. 
Vous n'êtes pas satisfait des prix que nous vous proposons ? 
Mettez nous au défi de répondre à vos besoins en créant une alerte prix.
												...
												<div class="flipper">
													<div class="front">
														<a href="detail-produit.php?id=<?php echo $product['id']; ?>">
															<img src="admin/assets/images/<?php echo $product['image']; ?>" alt="" class="img-responsive img-top-image">
														</a>
													</div>
													<div class="back">
														<a href="detail-produit.php?id=<?php echo $product['id']; ?>">
