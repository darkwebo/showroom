...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <div class="col-sm-3" align= "left">
        <form method="Post">
            <span>Search:</span><input id="search" type="search" class="form-control input-sm" placeholder="rechercher..." aria-controls="example">
        </form>
    </div>
    ...
    <div  id= "resultat">
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php 
        $products=$db->prepare('SELECT * FROM  liste_commandes join client where liste_commandes.id_Clt = client.id_Client');
        $products->execute();?>
        <tbody>
        <?php while($result=$products->fetch()):?>
            <tr data-expanded="true">
                <td><?php echo $result['id_Commande'];?></td>
                <td><?php echo $result['adresse@mail'];?></td>
