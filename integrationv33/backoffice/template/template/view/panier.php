	...
	<table cellspacing="2" align="center" height= "25%" width="80%"  cellpadding="10">
        ...
        <form  action="../core/verif.php" method="POST">
        	<?php
                ...
                <input type="hidden" name="login" value="<?php echo $product->id_Client; ?>">
        ...
        <tbody>
            <tr class="frame">
				...
				<td class="cart_description">
				    <div align="center">
				    	<h4> <input class="notborder" type="text" name="<?php echo("nom".$cmpt) ?>" id="<?php echo("nom".$cmpt) ?>" value="<?php echo $product['designation'];?>" size="25px" ></h4>
				...
				<td class="cart_quantity">
					<div class="cart_quantity_button" align="center">
						<input name="<?php echo("q".$cmpt) ?>" id="<?php echo("q".$cmpt) ?>"  class="cart_quantity_input" onchange="onchanger('<?php echo $cmpt;?>')" type = "number" max="100" value="1"  min ="1" />
