  ...
  <div class="panel panel-default">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="business/ajoutProduit.php" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="quantite"  value="" min="0" >
                        </div>
                    </div>
