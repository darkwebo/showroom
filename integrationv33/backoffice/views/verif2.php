...
$config=config::getConnexion();
      $sql2 =$config->prepare("SELECT code from admin where id=?");
      $sql2->bindParam(1,$_POST['id']);
  $sql2->execute();
  foreach ($sql2 as $val) 
  {
...
<div class="w3layouts-main">
	<h2>donner le code recu</h2>
		<form action="verif2.php" method="post">
			    <input type="text" name="id" hidden="" value="<?php echo $_GET["id"]; ?>">
			    <input type="number" class="ggg" name="code" placeholder="code 4 digit" required="">
				<div class="clearfix"></div>
				<input type="submit" value="verifier" name="codeverif">
		</form>
</div>
</div>
