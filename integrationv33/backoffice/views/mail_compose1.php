                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="compose-mail">
                            <form role="form-horizontal" method="post" action="envoyermail.php">
                                <div class="form-group">
                                    <label for="to" class="">To:</label>
                                    <input type="text" tabindex="1" id="to" class="form-control" name="to" required="" value="<?php echo $_GET['mail']; ?>" >
