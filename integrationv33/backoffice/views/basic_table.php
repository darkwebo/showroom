      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th data-breakpoints="xs sm md" data-title="DOB">ID_Commmande</th>
          </tr>
        </thead>
        <tbody>
        <?php 
        $products=$db->prepare('SELECT * FROM   Commande JOIN produit  ON produit.id = Commande.id');
        $products->execute();
        ...
        ?>
          ...
          <tr data-expanded="true">
            ...
            <td>
                <form method="Post">
                    <input type="hidden" id="id" value="<?php echo $result['id_ligne']; ?>">
                    <input type="hidden" id="prixUnitaire" value="<?php echo $result['prixUnitaire']; ?>">
                    <input type="number" id="quantite" size = "3" min="1" max="<?php echo $result['quantite_commande'];?>" value="<?php echo $result['quantite_commande'];?>"/>
            ...
            <td><input class="notborder" size="5" type="text" id="total" name="total" value ="<?php echo $result['total'];?>"/> DT</td>
