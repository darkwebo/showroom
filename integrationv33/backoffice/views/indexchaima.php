...
<!DOCTYPE html>
<head>
<title>Rachovski an Admin Panel Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Rachovski Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 Rachovski. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
	...
	$(document).ready(function() {
	   ...
	   jQuery('.small-graph-box .box-close').click(function() {
        ...
        fillOpacity:0.85,
            ...
            labels: ['All Rachovski', 'Returning Rachovski', 'Unique Rachovski'],
			pointSize: 2,
			hideHover: 'auto',
			resize: true
		});
