...
-->
<?PHP
include_once '../entites/log_in.php';
include_once '../core/log_in_manage.php';
if(isset($_POST['login']))
{
    $admin=new log_in();
    
    $admin->setpassword($_POST['Password']);
    $admin->setid($_POST['idadmin']);

    $admin_manage=new log_in_manage();
    $admin_manage->chercher_admin($admin);
...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
		<form action="Login.php" method="post">
			<input type="text" class="ggg" name="idadmin" placeholder="IDENTIFIANT" required="">
