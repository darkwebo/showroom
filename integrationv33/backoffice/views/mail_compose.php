...
-->
<?PHP
include_once '../entites/envoyer_mail.php';
include_once '../core/mail_manage.php';
session_start();

if(isset($_POST['to']))
{
 $admin=new mail();  
 $admin->setmail($_POST['envoyer']);
 $admin_sendmail=new mail_send();
 $admin_sendmail->envoyer_mail($admin);
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="compose-btn pull-right">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-check" name="envoyer"></i> envoyer</button>
                            
                        </div>
                        <div class="compose-mail">
                            <form role="form-horizontal" method="post" action="mail_compose.php">
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <input type="text" pattern="[A-Za-z]{1,50}" tabindex="2" id="bcc" class="form-control">
                                </div>
