				  ...
				  foreach($listeCategorieC as $categorie){
					  ?>
					    <tr>
							...
							<td>
							   <button type="" value="" class="btn-actions"><a href="modif-categorie.php?id=<?php echo $categorie['id']?>" class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a></button>
							  <form method="POST" action="business/supprimerCategorie.php">
