    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="../views/index.php">
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th>NOM Produit</th>
            <th>POURCENTAGE</th>
            <th data-breakpoints="xs">DATE DE DEBUT PROMO</th>
            <th data-breakpoints="xs sm md" data-title="DOB">DATE DE FIN PROMO</th>
            <th data-breakpoints="xs sm md" data-title="DOB">SUPPRESSION</th>
            <th data-breakpoints="xs sm md" data-title="DOB">MODIFICATION</th>
          </tr>
        </thead>
        <tbody>
            <?php
             require_once('../projetweb/modele/Produitpromo.php');
             $promo=new Produitpromo();
             $req=$promo->afficher_produit();
            ...
            <td><?php echo $donnee['pourcentage']; ?></td>
            <td><?php echo $donnee['date_debut_promo'];?></td>
            <td><?php echo $donnee['date_fin_promo']; ?></td>
            <td>
                <form method="post"  action="controlleur/indexproduit.php?action=supprimer1&amp;id=<?=$donnee['id']?>" class="form-horizontal bucket-form" >
                <button type="submit" class="btn btn-warning">supprimer</button>
                </form>          
            </td>
            <td>
            <form action="form_component.php#" methode="GET" class="form-horizontal bucket-form">
                <input type="hidden" name="val" value=<?=$donnee['id']?>>
