            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form id="upload" method="GET" action="controlleur/indexproduit.php?action1=send" enctype="multipart/form-data">
                            <div id="drop">
                                Promotion
                        ...
                        <form id="upload" method="GET" action="controlleur/indexproduit.php?action1=sms" enctype="multipart/form-data">
                            <div id="drop">
                                Promotion
                                <input type="hidden" name="action" value="sms">
                                <button type="submit" class="btn btn-success">sms</button>
                            </div>
