            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case"> Envoyer Mail
                           <form action="envoi_mail.php" methode="post" class="pull-right mail-src-position">
                    ...
                    <div class="panel-body">
                        <div class="compose-btn pull-right">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-check"></i> envoyer</button>
                            <button class="btn btn-sm"><i class="fa fa-times"></i> Discard</button>
                            <button class="btn btn-sm">Draft</button>
                        </div>
                        <div class="compose-mail">
                            <form action="envoi_mail1.php" role="form-horizontal" method="post">
                                <div class="form-group">
                                    <label for="to" class="">A:</label>
                                    <input type="text" tabindex="1" id="to" class="form-control" name="adresse">
                                ...
                                <div class="compose-editor">
                                    <textarea class="wysihtml5 form-control" rows="9" name="contenu"></textarea>
                                    <input type="file" class="default">
                                </div>
                                <div class="compose-btn">
                                    <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-check"></i> envoyer</button>
                                    <button class="btn btn-sm"><i class="fa fa-times"></i>Discard</button>
                                    <button class="btn btn-sm">Draft</button>
                                </div>
