                ...
                <div class="market-update-block clr-block-2">
                    ...
                    <h3>
                        <?php 
                          ...
                          $p= new Produit();
                          echo $p->compte_client();
                        ?>
                    </h3>
                    <p>ceci est le nombre de client</p>
                  </div>
                ...
                <div class="market-update-block clr-block-4">
                    ...
                    <div class="col-md-8 market-update-left">
                        <?php
                          ...
                          $req=$pro->compte_produit();
                          $data=$req->fetch();
                           $req->closeCursor();
                        
                            ?>
                        <h4>produit preferer</h4>
                        <h3>
                            j'aime:<?php echo $data['maximum'] ;?>
                              
                        </h3>
                        <p>nom: <?php echo $data['nom'];?></p>
                    </div>
                        <a href="gallery.php?id=<?php echo $data['nom']?>">
                        <span>détails</span>
                        </a>
                        <div class="clearfix"> </div>
                        <form action="typography.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $data['id'];?>">
                        <p><button type="submit" class="btn btn-success" id="modifier">lancer tracking</button></p>
                    </form>
                    </div>
                  <div class="clearfix"> </div>
                </div>
        ...
        <div class="grid_3 grid_5 w3l">
                ...
                <div class="tab-content">
                      ...
                      while($data=$req->fetch())
                    {
                        ...
                        <p><a href="basic_table.php?client=<?=$data['client']?>"><code><?php echo $nombre;?></code></a> client(s) aime(nt) le produit <code><a href="gallery.php?id=<?php echo $data['nom']?>"> <?php echo $data['nom']?></a></code></p>
                        <?php
                        }
                        elseif($compteur%6==2)
                        {
