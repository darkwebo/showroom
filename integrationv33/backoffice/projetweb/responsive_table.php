  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-4">
       ...
       <form action="responsive_table.php" method="POST">
      <div class="col-sm-3">
        <div class="input-group">
         
          <input type="search" class="input-sm form-control" id="search" name="rech">
    ...
    $sql = "SELECT * FROM produitpromo  where id LIKe '%$search%'";
    ...
    <tr>
          ...
          <?php
             ...
             elseif(!isset($_POST['rech']) OR $_POST['rech']="")
             {
