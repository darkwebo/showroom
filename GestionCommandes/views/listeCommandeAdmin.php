...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img  class="main-logo" src="img/logo/logo.jpg" alt="" height="220" width="200"></a>
                <strong><img src="img/logo/logo.jpg" alt="" height="2" width="2"/></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Platinium Auto</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="indexx.html"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                ...
                                <li><a title="Product List" href="listeCommandeAdmin.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Product List</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="listeCommandeAdmin.php">Product List</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">commande List</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
  ...
  ?>
	...
	Modifier</a></td>
                            ...
                            <form method="POST" action="listeCommandeTrie.php">
                                                      <input type="submit" class="btn btn-primary waves-effect waves-light m-r-10" name="trier" value="trier">
                            </form>

                          	<form method="POST" action="rechercherCommande.php">
                          <input type="submit" class="btn btn-primary waves-effect waves-light m-r-10" name="rechercher" value="rechercher">
                         <input value="<?PHP echo $row['id_produit']; ?>" name="id_produit" class="form-control">
                         </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://colorlib.com/wp/templates/">Platinium Auto</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
